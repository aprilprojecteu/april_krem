...
from april_krem.OSAI_components import (
    Item,
    ArmPose,
    Actions,
    Environment,
...
class OSAIDomain(Bridge):
    def __init__(self, krem_logging, temporal: bool = False) -> None:
        ...
        self.create_types([Item, ArmPose])
        ...
        self.insertion_insert = Method(
            "insertion_insert", case=type_item, insert=type_item
        )
        ...
        s1 = self.insertion_insert.add_subtask(
            self.insert, self.insertion_insert.case, self.insertion_insert.insert
        )
        ...
        self.insertion_move_arm_2 = Method(
            "insertion_move_arm_2", case=type_item, insert=type_item
        )
        ...
        self.insertion_move_arm_2.add_precondition(self.current_arm_pose(self.unknown))
        ...
        self.insertion_pick_insert = Method(
            "insertion_pick_insert", case=type_item, insert=type_item
        )
        ...
        s1 = self.insertion_pick_insert.add_subtask(
            self.pick_insert, self.insertion_pick_insert.insert
        )
        s2 = self.insertion_pick_insert.add_subtask(self.move_arm, self.over_fixture)
        s3 = self.insertion_pick_insert.add_subtask(
            self.insert,
            self.insertion_pick_insert.case,
            self.insertion_pick_insert.insert,
        )
        s4 = self.insertion_pick_insert.add_subtask(self.move_arm, self.over_fixture)
        s5 = self.insertion_pick_insert.add_subtask(self.inspect_set)
        s6 = self.insertion_pick_insert.add_subtask(self.perceive_set)
        self.insertion_pick_insert.set_ordered(s1, s2, s3, s4, s5, s6)

        # placed_case, move over pallet, pick insert, move to fixture,
        # insert, inspect, perceive
        self.insertion_move_arm_3 = Method(
            "insertion_move_arm_3", case=type_item, insert=type_item
        )
        ...
        self.insertion_move_arm_3.add_precondition(self.holding(self.nothing))
        s1 = self.insertion_move_arm_3.add_subtask(self.move_arm, self.over_pallet)
        s2 = self.insertion_move_arm_3.add_subtask(
            self.pick_insert, self.insertion_move_arm_3.insert
        )
        s3 = self.insertion_move_arm_3.add_subtask(self.move_arm, self.over_fixture)
        ...
        s6 = self.insertion_move_arm_3.add_subtask(self.inspect_set)
        ...
        self.insertion_place_case = Method(
            "insertion_place_case", case=type_item, insert=type_item
        )
        ...
        s1 = self.insertion_place_case.add_subtask(
            self.place_case, self.insertion_place_case.case
        )
        s2 = self.insertion_place_case.add_subtask(self.move_arm, self.over_pallet)
        s3 = self.insertion_place_case.add_subtask(
            self.pick_insert, self.insertion_place_case.insert
        )
        s4 = self.insertion_place_case.add_subtask(self.move_arm, self.over_fixture)
        ...
        s7 = self.insertion_place_case.add_subtask(self.inspect_set)
        s8 = self.insertion_place_case.add_subtask(self.perceive_set)
        self.insertion_place_case.set_ordered(s1, s2, s3, s4, s5, s6, s7, s8)

        # case in hand, move over fixture, place case
        self.insertion_move_arm_4 = Method(
            "insertion_move_arm_4", case=type_item, insert=type_item
        )
        ...
        self.insertion_move_arm_4.add_precondition(Not(self.case_is_placed()))
        self.insertion_move_arm_4.add_precondition(Not(self.inserted_insert()))
        self.insertion_move_arm_4.add_precondition(
            self.current_arm_pose(self.over_conveyor)
        )
        self.insertion_move_arm_4.add_precondition(
            self.holding(self.insertion_move_arm_4.case)
        )
        s1 = self.insertion_move_arm_4.add_subtask(self.move_arm, self.over_fixture)
        s2 = self.insertion_move_arm_4.add_subtask(
            self.place_case, self.insertion_move_arm_4.case
        )
        s3 = self.insertion_move_arm_4.add_subtask(self.move_arm, self.over_pallet)
        s4 = self.insertion_move_arm_4.add_subtask(
            self.pick_insert, self.insertion_move_arm_4.insert
        )
        s5 = self.insertion_move_arm_4.add_subtask(self.move_arm, self.over_fixture)
        s6 = self.insertion_move_arm_4.add_subtask(
            self.insert,
            self.insertion_move_arm_4.case,
            self.insertion_move_arm_4.insert,
        )
        s7 = self.insertion_move_arm_4.add_subtask(self.move_arm, self.over_fixture)
        s8 = self.insertion_move_arm_4.add_subtask(self.inspect_set)
        s9 = self.insertion_move_arm_4.add_subtask(self.perceive_set)
        self.insertion_move_arm_4.set_ordered(s1, s2, s3, s4, s5, s6, s7, s8, s9)

        # case in hand, move over conveyor, then over fixture, place case
        self.insertion_move_arm_5 = Method(
            "insertion_move_arm_5", case=type_item, insert=type_item
        )
        ...
        self.insertion_move_arm_5.add_precondition(Not(self.case_is_placed()))
        ...
        self.insertion_move_arm_5.add_precondition(
            self.holding(self.insertion_move_arm_5.case)
        )
        s1 = self.insertion_move_arm_5.add_subtask(self.move_arm, self.over_conveyor)
        s2 = self.insertion_move_arm_5.add_subtask(self.move_arm, self.over_fixture)
        s3 = self.insertion_move_arm_5.add_subtask(
            self.place_case, self.insertion_move_arm_5.case
        )
        s4 = self.insertion_move_arm_5.add_subtask(self.move_arm, self.over_pallet)
        s5 = self.insertion_move_arm_5.add_subtask(
            self.pick_insert, self.insertion_move_arm_5.insert
        )
        s6 = self.insertion_move_arm_5.add_subtask(self.move_arm, self.over_fixture)
        s7 = self.insertion_move_arm_5.add_subtask(
            self.insert,
            self.insertion_move_arm_5.case,
            self.insertion_move_arm_5.insert,
        )
        s8 = self.insertion_move_arm_5.add_subtask(self.move_arm, self.over_fixture)
        s9 = self.insertion_move_arm_5.add_subtask(self.inspect_set)
        s10 = self.insertion_move_arm_5.add_subtask(self.perceive_set)
        self.insertion_move_arm_5.set_ordered(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10)

        # case location and type known, pick, insert, inspect, perceive
        self.insertion_full = Method("insertion_full", case=type_item, insert=type_item)
        ...
        s1 = self.insertion_full.add_subtask(self.pick_case, self.insertion_full.case)
        ...
        s4 = self.insertion_full.add_subtask(self.place_case, self.insertion_full.case)
        s5 = self.insertion_full.add_subtask(self.move_arm, self.over_pallet)
        s6 = self.insertion_full.add_subtask(
            self.pick_insert, self.insertion_full.insert
        )
        s7 = self.insertion_full.add_subtask(self.move_arm, self.over_fixture)
        s8 = self.insertion_full.add_subtask(
            self.insert, self.insertion_full.case, self.insertion_full.insert
        )
        s9 = self.insertion_full.add_subtask(self.move_arm, self.over_fixture)
        s10 = self.insertion_full.add_subtask(self.inspect_set)
        s11 = self.insertion_full.add_subtask(self.perceive_set)
        self.insertion_full.set_ordered(s1, s2, s3, s4, s5, s6, s7, s8, s9, s10, s11)
        ...
        self.assemble_set_full = Method(
            "assemble_set_full", case=type_item, insert=type_item, set=type_item
        )
        self.assemble_set_full.set_task(
            self.assemble_set,
            self.assemble_set_full.case,
            self.assemble_set_full.insert,
            self.assemble_set_full.set,
        )
        s1 = self.assemble_set_full.add_subtask(
            self.get_case, self.assemble_set_full.case
        )
        s2 = self.assemble_set_full.add_subtask(
            self.insertion, self.assemble_set_full.case, self.assemble_set_full.insert
        )
        s3 = self.assemble_set_full.add_subtask(
            self.place_set, self.assemble_set_full.set
        )
        self.assemble_set_full.set_ordered(s1, s2, s3)
    ...
    def _create_domain_actions(self, temporal: bool = False) -> None:
        ...
        if temporal:
            ...
            self.perceive_insert.add_precondition(self.item_size_known())
            ...
            self.pick_case, [c] = self.create_action(
                "pick_case", case=Item, _callable=actions.pick_case
            )
            ...
            self.pick_insert, [i] = self.create_action(
                "pick_insert", insert=Item, _callable=actions.pick_insert
            )
            ...
            self.place_case, [c] = self.create_action(
                "place_case", case=Item, _callable=actions.place_case
            )
            ...
            self.insert, [c, i] = self.create_action(
                "insert",
                case=Item,
                insert=Item,
